 ...
 */
class getBebeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BebeRepository' shared autowired service.
     *
     * @return \App\Repository\BebeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BebeRepository.php';

        return $container->privates['App\\Repository\\BebeRepository'] = new \App\Repository\BebeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
